---
artifact: 03_test-scenarios.spec.md
...
# Contract — `03_test-scenarios.spec.md` (what will be tested)
...
- [ ] Every acceptance criterion from `03_alignment.log.md` maps to at least one scenario.
...
- **Discussion:** [03_alignment.log.md](03_alignment.log.md) · **Design:** [03_target-solution.spec.md](03_target-solution.spec.md)
